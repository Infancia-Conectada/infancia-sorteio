...
<body>
    ...
    <main class="main-content">
        ...
        <section class="section-cadastrados">
            <h2 class="section-title">
                <svg class="icon-title" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                    <circle cx="9" cy="7" r="4"></circle>
            ...
            <div class="card cadastrados-card">
                <div id="listaCadastrados" class="lista-cadastrados">
                    <div class="loading-cadastrados">
    ...
    <!-- Footer Contact -->
            <div class="footer-contact">
                ...
                <a href="https://wa.me/5516996024388" class="whatsapp-link" target="_blank" rel="noopener noreferrer">
